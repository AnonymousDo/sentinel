...
sentinel_cfg = HelpicoConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_helpicod_proto_version_with_sentinel_ping = 70207


def get_helpico_conf():
    home = os.environ.get('HOME')

    helpico_conf = os.path.join(home, ".helpicocore/helpico.conf")
    if sys.platform == 'darwin':
        helpico_conf = os.path.join(home, "Library/Application Support/HelpicoCore/helpico.conf")

    helpico_conf = sentinel_cfg.get('helpico_conf', helpico_conf)
