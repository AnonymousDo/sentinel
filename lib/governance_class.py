...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to helpicod "gobject list" output
    ...
    def helpicod_serialise(self):
        import helpicolib
        return helpicolib.SHIM_serialise_for_helpicod(self.serialise())
